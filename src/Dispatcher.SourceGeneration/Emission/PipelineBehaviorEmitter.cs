...
internal static class PipelineBehaviorEmitter
{
        ...
        GenerationResult result)
    {
        ...
        source.AppendLine("/// Provides source-generated registration methods for open generic pipeline behaviors.");
        source.AppendLine("/// </summary>");
        source.AppendLine("public static class GeneratedPipelineBehaviorServiceCollectionExtensions");
        source.AppendLine("{");
        source.AppendLine("    /// <summary>");
        source.AppendLine("    /// Registers a pipeline behavior discovered by the Dispatcher generator.");
        source.AppendLine("    /// </summary>");
        source.AppendLine("    /// <param name=\"services\">The service collection to add the behavior to.</param>");
        source.AppendLine("    /// <param name=\"behaviorType\">The open generic behavior type to register.</param>");
        ...
        source.AppendLine("    /// <paramref name=\"services\"/> or <paramref name=\"behaviorType\"/> is <see langword=\"null\"/>.");
        source.AppendLine("    /// </exception>");
        source.AppendLine("    /// <exception cref=\"global::System.ArgumentException\">");
        source.AppendLine("    /// <paramref name=\"behaviorType\"/> was not discovered by the Dispatcher generator.");
        source.AppendLine("    /// </exception>");
        ...
        source.AppendLine();
        source.AppendLine("    /// <summary>");
        source.AppendLine("    /// Registers a pipeline behavior discovered by the Dispatcher generator using the specified options.");
        source.AppendLine("    /// </summary>");
        source.AppendLine("    /// <param name=\"services\">The service collection to add the behavior to.</param>");
        source.AppendLine("    /// <param name=\"behaviorType\">The open generic behavior type to register.</param>");
        source.AppendLine("    /// <param name=\"configure\">The delegate that configures behavior registration.</param>");
        source.AppendLine("    /// <returns>The same service collection so that additional calls can be chained.</returns>");
        source.AppendLine("    /// <exception cref=\"global::System.ArgumentNullException\">");
        source.AppendLine("    /// <paramref name=\"services\"/>, <paramref name=\"behaviorType\"/>, or <paramref name=\"configure\"/> is <see langword=\"null\"/>.");
        source.AppendLine("    /// </exception>");
        source.AppendLine("    /// <exception cref=\"global::System.ArgumentException\">");
        source.AppendLine("    /// <paramref name=\"behaviorType\"/> was not discovered by the Dispatcher generator.");
        source.AppendLine("    /// </exception>");
