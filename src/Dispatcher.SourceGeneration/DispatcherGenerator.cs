...
public sealed class DispatcherGenerator : IIncrementalGenerator
{
    ...
    private static void Emit(SourceProductionContext context, GenerationResult result)
    {
        ...
        source.AppendLine();
        source.AppendLine("namespace Dispatcher.Extensions.DependencyInjection;");
        source.AppendLine();
        ...
        {
            source.Append("        global::Dispatcher.Extensions.DependencyInjection.TypedDispatcherServiceCollectionExtensions.")
