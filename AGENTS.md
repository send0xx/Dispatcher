...
For package-affecting changes, pack all three libraries and inspect their dependencies and XML documentation:
...
dotnet pack src/Dispatcher.Extensions.DependencyInjection/Dispatcher.Extensions.DependencyInjection.csproj -c Release -o artifacts/packages
```
